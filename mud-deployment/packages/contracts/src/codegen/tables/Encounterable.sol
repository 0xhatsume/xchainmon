...
library Encounterable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "Encounterable", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000456e636f756e74657261626c65000000);
