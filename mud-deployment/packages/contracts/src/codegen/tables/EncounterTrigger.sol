...
library EncounterTrigger {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "EncounterTrigger", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000456e636f756e74657254726967676572);
